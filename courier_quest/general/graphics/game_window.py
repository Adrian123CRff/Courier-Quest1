...
class MapPlayerView(View):
    def __init__(self, state) -> None:
        ...
        # Inicializar player_stats en el state (compatibilidad)
    ...
    def _initialize_game_systems(self):
        try:
            ...
            try:
                ...
                # tolerante si initialize no existe / tiene otra firma
                pass

            # Pasar referencia de mapa al game_manager si existe API
            try:
            ...
            print(f"🎮 SISTEMAS DE JUEGO INICIALIZADOS")
    ...
    def set_game_systems(self, game_manager, job_manager):
        ...
        if game_manager:
            # Si game_manager espera recibir un player_manager referencia
            try:
                game_manager.player_manager = self.player
            except Exception:
                pass

        # Cargar trabajos iniciales desde state
    ...
    def _spawn_next_notification_immediate(self):
        ...
        # show notification message (also logged)
    ...
    def _accept_notification(self):
        ...
        # comprobar capacidad de inventario
        ...
        try:
            for job in self.job_manager.all_jobs():
                ...
                if getattr(job, "picked_up", False) and not getattr(job, "completed", False):
                    ...
                    arcade.draw_rect_outline(dx, dy, TILE_SIZE * 0.6, TILE_SIZE * 0.6, arcade.color.BLACK, 2)
    ...
    def on_update(self, dt: float) -> None:
        ...
        # Gestion notificaciones de jobs
        if self.job_notification_active:
        ...
        try:
            ...
            try:
                # WeatherMarkov tiene current_condition/current_multiplier
