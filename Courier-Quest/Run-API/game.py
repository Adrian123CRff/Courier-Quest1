import arcade
from api_handler import APIHandler  # Debes tener este módulo
...
class CourierQuest(arcade.Window):
    """
    Estados:
      - "loading": obteniendo datos de la API/caché
      - "menu": menú principal
      - "playing": juego activo (mover personaje)
    """
    def __init__(self):
        ...
        # --- Textos (usar arcade.Text para evitar PerformanceWarning) ---
    ...
    # -------------------------
    def setup(self):
        """Preparar juego (cargar datos)."""
        self.load_game_data()

    def load_game_data(self):
        """Cargar datos desde API/caché."""
        ...
        # Prepara textos del menú con los datos actuales
        source = "API" if getattr(self.api_handler, "last_source", "") == "api" else "Caché/Local"
    ...
    def draw_loading_screen(self):
        self.bg_list.draw()  # dibuja el fondo
    ...
    def start_playing(self):
        """Inicializa sprites y entra al estado 'playing'."""
    ...
    def on_resize(self, width: int, height: int):
        """Ajusta posiciones y reescala el fondo al cambiar el tamaño de la ventana."""
        ...
        # Reposicionar y reescalar el fondo
    ...
    def _resize_bg_to_cover(self, width: int, height: int):
        """Escala el sprite de fondo para que cubra toda la ventana (efecto 'cover')."""
